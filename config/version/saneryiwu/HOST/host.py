...
import random
class host():
    def __init__(self,id,name,type,roles,public_ips,private_ip,admin_ip,gateway_ip,description,protection_domain_id,status,up,cluster='cluster1'):
        self.id = id
        self.name = name
        self.type = type
        self.roles = roles
    ...
    def add_host(self,public_ip,private_ip,gateway_ip,admin_ip,roles,type,description):
        '''
...
if __name__ == "__main__":
    test = host('1','node1',type=1,roles=1,public_ips=1,private_ip=1,admin_ip=1,gateway_ip=1,description=None,protection_domain_id=1,status=1,up=1,cluster='1')
