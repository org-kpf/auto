...
class access_path():
    def __init__(self, id, name, type, description, protection_domain_id, volume_num,client_group_num,chap, tname, tsecret, status, action_status, create):
        self.id = id
        self.name = name
        self.type = type
        ...
        self.create = create
    @staticmethod
    def create_access_path(type,name,tname,tsecret,chap,description):
        #name，长度不超过128个字符
