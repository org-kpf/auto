...
import time
class mapping_group():
    def __init__(self,id,access_path_id,access_path_name,client_group_id,client_group_name,status,create_time):
        self.id = id
    ...
    @staticmethod
    def create_mapping_group(block_volumes_ids, access_path, client_group):
        if client_group != '':
